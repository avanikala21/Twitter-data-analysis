...
access_token = "-nmw6T5zanyDMEVtcXs7XmwF4fASz0B"
access_token_secret = ""
...
connectionString = "DefaultEndpointsProtocol=https;AccountName=storageaccountsindhu;AccountKey=--"
...
with open(outputBlobName, "w") as outfile:
    json.dump(hashtagsdata, outfile)
